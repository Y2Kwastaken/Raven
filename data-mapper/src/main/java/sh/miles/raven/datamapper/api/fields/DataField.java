...
/**
 * DataField is a class that represents a field in a Database. It is represented
 * by a key value pair. The key is the name of the field in the database and the
 * value represents the value of the field. The value can be any type as long as
 * it supported for retrieval by the database.
 * 
